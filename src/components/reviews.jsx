...
function Reviews() {
  ...
  return (
    <div className='reviewSection'>
      ...
      <div className='reviewCard'>
      <span class="yelp-review" data-review-id="2fUYj9UqTay0R1f6sbJPNg" data-hostname="www.yelp.com">Read <a href="https://www.yelp.com/user_details?userid=jODds-c5YOBc0t9TYcjDtQ" rel="nofollow noopener">Dillon W.</a>'s <a href="https://www.yelp.com/biz/import-motorcycle-specialist-valencia?hrid=2fUYj9UqTay0R1f6sbJPNg" rel="nofollow noopener">review</a> of <a href="https://www.yelp.com/biz/-Ev8cL804gb0tNnAZHSSoA" rel="nofollow noopener">Import Motorcycle Specialist</a> on <a href="https://www.yelp.com" rel="nofollow noopener">Yelp</a><script src="https://www.yelp.com/embed/widgets.js" type="text/javascript" async></script></span>
        </div>
      <div className='reviewCard'>
